...
import { profileSchema, imageSchema, propertySchema, validateWithZodSchema, createReviewSchema } from "./schemas";
import db from './db';
import { redirect } from "next/navigation";
import { revalidatePath } from "next/cache";
import { uploadImage } from "./supabase";
import { calculateTotals } from "./caculateTotals";
...
export const createReviewAction = async (prevState: any, formData: FormData) => {
    ...
    try {
        ...
        const validateFields = validateWithZodSchema(createReviewSchema, rawData);
...
export const fetchStats = async () => {
    ...
    return { userCount, propertyCount, bookingCount };
}
