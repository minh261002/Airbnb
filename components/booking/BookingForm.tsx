...
const BookingForm = () => {
    ...
    const { totalNight, subTotal, cleaning, services, tax, total } = calculateTotals({ checkIn, checkOut, price });
    return (
        <Card className="p-8 mb-4">
            <CardTitle className="mb-8">Booking Summary</CardTitle>
            <FormRow label={`${formatCurrency(price)} x ${totalNight} nights`} amount={subTotal} />
